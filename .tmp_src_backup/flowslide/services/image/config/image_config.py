        ...
        try:
            ...
            if pollinations_safe is not None:
                if isinstance(pollinations_safe, bool):
                    ...
                    self._config["pollinations"]["default_safe"] = (
                        str(pollinations_safe).lower() == "true"
                    )
            ...
            if pollinations_nologo is not None:
                if isinstance(pollinations_nologo, bool):
                    ...
                    self._config["pollinations"]["default_nologo"] = (
                        str(pollinations_nologo).lower() == "true"
                    )
