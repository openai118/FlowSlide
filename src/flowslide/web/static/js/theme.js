...
(function(){
  ...
  var lightIcon = '/static/images/flowslide-logo-light.svg';
  var darkIcon  = '/static/images/flowslide-logo-dark.svg';
  if(ico){ ico.href = (theme==='dark')? darkIcon: lightIcon; }
  var bl=document.getElementById('brand-logo');
  if(bl){ bl.src = (theme==='dark')? darkIcon: lightIcon; }
