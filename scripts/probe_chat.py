#!/usr/bin/env python3
"""Probe script: POST to /v1/chat/completions on the upstream proxy.

Supply API key via CLI arg or API_KEY env var. Example (PowerShell):
  $env:API_KEY='1144'; python scripts\\probe_chat.py
"""
import os
import sys
...
def do_post_chat(api_key=None):
    ...
    try:
        ...
        # Print full traceback for debugging network/ssl issues
        import traceback
